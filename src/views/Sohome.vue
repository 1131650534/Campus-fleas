    ...
    <div class="backgroun">
      ...
      <van-swipe class="tbr" :autoplay="3000" indicator-color="white">
        <van-swipe-item class="imgs">
          <img src="http://livewebbs2.msstatic.com/home_recommend_live_app_1571986668.jpg?ips_thumbnail/0/w/700/"/>
        </van-swipe-item>
        <van-swipe-item class="imgs">
          <img src="//livewebbs2.msstatic.com/home_recommend_live_app_1572575155.jpg?ips_thumbnail/0/w/700/"/>
        </van-swipe-item>
        <van-swipe-item class="imgs">
          <img src="//livewebbs2.msstatic.com/home_recommend_live_app_1538293989.jpg?ips_thumbnail/0/w/700/"/>
        </van-swipe-item>
        <van-swipe-item class="imgs">
          <img src="//livewebbs2.msstatic.com/home_recommend_live_app_1477487193.jpg?ips_thumbnail/0/w/700/"/>
        </van-swipe-item>
      </van-swipe>
    </div>
    <div class="activity">
      <img src="http://img51.ddimg.cn/222060123100431_y.jpg" />
    </div>
